...
const Navbar = () => {
  ...
  return (
    <nav className='fixed w-full z-50 bg-[rgba(26,26,26,0.9)] backdrop-blur-sm py-4 px-8 shadow-lg'>
      
      <div className='container mx-auto flex justify-between items-center'>
        <div>
            <a href="#" className='text-3xl font-bold text-white'>
                Sahid
                <span className='text-purple-500'> Alam</span>
                <div className='w-4 h-4 bg-[var(--color-purple)] rounded-full'></div>
            </a>
        </div>
